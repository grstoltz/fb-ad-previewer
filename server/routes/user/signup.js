...
router.post('/', (req, res) => {
  console.log(config);
  const token = jwt.sign({ email: req.body.email }, config.JWTsecret, {}); // assigning token which be userd to activate the signed account
    ...
    (err, account) => {
      if (err) {
        ...
        nodemailer.createTestAccount((err, mailAcc) => {
          ...
          const msg = `please validate your account ${
            config.server
          }/activate/${token}/${req.body.email}`;
                                                ...
                                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                <td style="font-family: 'Pattaya', sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;"> <a href='${
                                                                  config.server
                                                                }/activate/${token}/${
              req.body.email
        ...
        res.send({ msg: 'check your email', account });
      }
    }
  );
});
